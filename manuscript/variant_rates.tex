...
I first use Nextclade \citep{aksamentov_nextclade_2021} to assign all sequences to one of the Nextstrain clades \citep{hadfield_nextstrain_2018}, which are denoted by a Year-Letter combination (e.g.~19A, 20A, 20B, \ldots).
...
\begin{figure*}
    ...
    The red outlier is `composite' clade 19++ with inflated rates due to adaptive mutations.
...
To avoid loss of signal through sequencing errors, I drop lineages at which only a single mutation
To turn this into a measure of mutational tolerance, I normalize the number of lineages with minor variation by the rate at which mutation rate of the ancestral base at this position.
